...
class _$CommentResponse extends CommentResponse {
  ...
  final int? pages;
  @override
  final BuiltList<CommentModel>? items;
  @override
...
class CommentResponseBuilder
  ...
  ListBuilder<CommentModel>? _items;
  ListBuilder<CommentModel> get items =>
      _$this._items ??= new ListBuilder<CommentModel>();
  set items(ListBuilder<CommentModel>? items) => _$this._items = items;
  ...
  CommentResponseBuilder() {
    CommentResponse._initializeBuilder(this);
  }

...
import 'package:dart_api_provider/src/model/channel_model.dart';
...
abstract class ChannelResponse implements Built<ChannelResponse, ChannelResponseBuilder>, BaseModel {
    ...
    BuiltList<ChannelModel>? get items;
    ...
    static void _initializeBuilder(ChannelResponseBuilder b) => b
        ..items = ListBuilder()
        ..hasPrevious = false
        ..hasNext = false;
    ...
    static ChannelResponse fromJson(Map<String, dynamic> json) {
      return serializers.deserializeWith(serializer, json) ?? ChannelResponse();
    }
        ...
        if (object.items != null) {
            result
                ...
                ..add(serializers.serialize(object.items,
                    specifiedType: const FullType(BuiltList, [FullType(ChannelModel)])));
        }
            ...
            switch (key) {
                ...
                case r'items':
                    result.items.replace(serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(ChannelModel)])) as BuiltList<ChannelModel>);
                    break;
                case r'hasPrevious':

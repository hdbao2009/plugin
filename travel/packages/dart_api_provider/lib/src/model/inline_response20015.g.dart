...
class InlineResponse20015Builder
  ...
  PaymentResponsesBuilder? _result;
  PaymentResponsesBuilder get result =>
      _$this._result ??= new PaymentResponsesBuilder();
  set result(PaymentResponsesBuilder? result) => _$this._result = result;

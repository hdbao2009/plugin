...
abstract class InlineResponse20019 implements Built<InlineResponse20019, InlineResponse20019Builder>, BaseModel {
    @BuiltValueField(wireName: r'successful')
    bool? get successful;

    @BuiltValueField(wireName: r'result')
    BuiltList<AdsModel>? get result;
    ...
    static InlineResponse20019 fromJson(Map<String, dynamic> json) {
      return serializers.deserializeWith(serializer, json) ?? InlineResponse20019();
    }
        ...
        if (object.result != null) {
            result
                ...
                ..add(serializers.serialize(object.result,
                    specifiedType: const FullType(BuiltList, [FullType(AdsModel)])));
        }
            ...
            switch (key) {
                ...
                case r'result':
                    result.result.replace(serializers.deserialize(value,
                        specifiedType: const FullType(BuiltList, [FullType(AdsModel)])) as BuiltList<AdsModel>);
                    break;
                case r'errorCode':

...
part 'home_playlist.g.dart';

// ignore_for_file: unused_import, unused_field

abstract class HomePlaylist implements Built<HomePlaylist, HomePlaylistBuilder>, BaseModel {
    ...
    static void _initializeBuilder(HomePlaylistBuilder b) => b
        ..id = ''
        ..channelName = ''
        ..channelDescription = ''
        ..playlistId = ''
    ...
    factory HomePlaylist([void updates(HomePlaylistBuilder b)]) = _$HomePlaylist;

    @BuiltValueSerializer(custom: true)
    static Serializer<HomePlaylist> get serializer => _$HomePlaylistSerializer();

    static HomePlaylist fromJson(Map<String, dynamic> json) {
      return serializers.deserializeWith(serializer, json) ?? HomePlaylist();
    }
...
class _$HomePlaylistSerializer implements StructuredSerializer<HomePlaylist> {
    @override
    final Iterable<Type> types = const [HomePlaylist, _$HomePlaylist];

    @override
    final String wireName = r'HomePlaylist';

    @override
    Iterable<Object?> serialize(Serializers serializers, HomePlaylist object,
    ...
    @override
    HomePlaylist deserialize(Serializers serializers, Iterable<Object?> serialized,
        {FullType specifiedType = FullType.unspecified}) {
        final result = HomePlaylistBuilder();

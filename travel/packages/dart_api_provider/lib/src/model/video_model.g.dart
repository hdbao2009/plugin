...
class VideoModelBuilder implements Builder<VideoModel, VideoModelBuilder> {
  ...
  VideoModelBuilder() {
    VideoModel._initializeBuilder(this);
  }
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'VideoModel', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
